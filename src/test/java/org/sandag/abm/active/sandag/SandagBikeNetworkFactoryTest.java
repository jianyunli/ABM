...
//    SimpleNetwork<SandagBikeNode, SandagBikeEdge, SandagBikeTraversal> network;
//    
//    @Before
//    public void setUp() {
...
//                count = count + ( node.getId() == edge.getToNode() ? 1 : 0);
//            }
...
//                count = count + ( node.getId() == edge.getFromNode() ? 1 : 0);
//            }
//            assertEquals(1,count);
//        }
//    }
...
//        while (edgeIterator.hasNext()) {
//            edge = edgeIterator.next();
//            for (int s : network.getSuccessorIds(edge.getToNode()) ) {
//                assertTrue(network.containsTraversalIds(new int[] {edge.getFromNode(), edge.getToNode(), s}));
//            }
//        }
//    }
//    
...
//        while (edgeIterator.hasNext()) {
//            edge = edgeIterator.next();
//            for (int p : network.getPredecessorIds(edge.getFromNode()) ) {
//                assertTrue(network.containsTraversalIds(new int[] {p, edge.getFromNode(), edge.getToNode()}));
//            }
//        }
//    }
//    
